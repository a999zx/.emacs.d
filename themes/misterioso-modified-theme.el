...
(custom-theme-set-faces
 ...
 '(region ((t (:background "PaleVioletRed1" :foreground "#e1e1e0"))))
 ...
 '(default ((t (:background "gray20" :foreground "#e1e1e0")))))

(provide-theme 'misterioso-modified)
